...
const STRINGS = {
  en: {
    ...
    'card.tokensTitle': '{total} tokens total · {invocations}× invocations · {sessions} sessions',
    ...
    'modal.report.topTokens': 'Top 5 by Tokens (all-time)',
    'modal.report.tokensRow': '{tokens} tok · {invocations}× invocations',
  ...
  ko: {
    ...
    'card.tokens': '{tokens} 토큰',
    'card.tokensTitle': '누적 {total} 토큰 · {invocations}회 호출 · {sessions} 세션',
    ...
    'modal.report.topTokens': '토큰 사용 TOP 5 (전체 누적)',
    'modal.report.tokensRow': '{tokens} 토큰 · {invocations}회 호출',
  ...
  ja: {
    ...
    'card.tokens': '{tokens} tok',
    'card.tokensTitle': '累計 {total} トークン · {invocations} 回呼出 · {sessions} セッション',
    ...
    'modal.report.topTokens': 'トークン使用 TOP 5 (累計)',
    'modal.report.tokensRow': '{tokens} tok · {invocations} 回呼出',
  ...
  zh: {
    ...
    'card.tokens': '{tokens} tok',
    'card.tokensTitle': '累计 {total} tokens · 调用 {invocations} 次 · {sessions} 个会话',
    ...
    'modal.report.topTokens': 'Token 使用 TOP 5 (累计)',
    'modal.report.tokensRow': '{tokens} tok · {invocations} 次调用',
