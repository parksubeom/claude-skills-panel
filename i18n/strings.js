...
const STRINGS = {
  en: {
    ...
    'modal.buddy.preBranch': '{remaining} more uses until class is decided',
    'modal.buddy.skillStatsBefore': 'Use any skill — your most-used category will decide your class at LV.3.',
    'modal.buddy.skillStatsAfter': 'Skill usage by category — current class highlighted.',
    ...
    'toast.classBranch': '⚔️ {name} has chosen the path of the {role} — {stage}!',
  ...
  ko: {
    ...
    'modal.buddy.preBranch': '클래스 결정까지 {remaining}회 남음',
    'modal.buddy.skillStatsBefore': '스킬을 사용해보세요 — 가장 많이 쓴 카테고리가 LV.3에서 클래스가 됩니다.',
    'modal.buddy.skillStatsAfter': '카테고리별 사용량 — 현재 클래스 강조.',
    ...
    'toast.classBranch': '⚔️ {name}는 {role}의 길을 선택했다 — {stage}!',
  ...
  ja: {
    ...
    'modal.buddy.preBranch': 'クラス決定まであと {remaining} 回',
    'modal.buddy.skillStatsBefore': 'スキルを使ってみよう — 一番使ったカテゴリが LV.3 でクラスになります。',
    'modal.buddy.skillStatsAfter': 'カテゴリ別使用量 — 現在のクラスを強調。',
    ...
    'toast.classBranch': '⚔️ {name} は {role} の道を選んだ — {stage}!',
  ...
  zh: {
    ...
    'modal.buddy.preBranch': '距离决定职业还需 {remaining} 次',
    'modal.buddy.skillStatsBefore': '使用任何技能 — 你最常用的类别将在 LV.3 时决定职业。',
    'modal.buddy.skillStatsAfter': '按类别使用情况 — 当前职业突出显示。',
    ...
    'toast.evolution': '🎉 {name} 进化为 {stage}!',
    'toast.classBranch': '⚔️ {name} 选择了 {role} 之路 — {stage}!',
